package dev.vatuu.archiesarmy.client.geometry;
...
public class GeometryManager implements SimpleSynchronousResourceReloadListener, AutoCloseable{
    ...
    public static final Identifier MISSING_IDENTIFIER = ArchiesArmy.id("");
    private static final Identifier LISTENER_ID = ArchiesArmy.id("geometry");
    ...
    public void apply(ResourceManager manager) {
        ...
        modelData.put(MISSING_IDENTIFIER, ArchiesArmyClient.GSON_CLIENT.fromJson(MISSING_MODEL_DATA, GeometryData.class));
    }
    ...
    private static final String MISSING_MODEL_DATA = "{\n" +
            ...
            "\t\t{\n" +
            "\t\t\t\"description\": {\n" +
            "\t\t\t\t\"identifier\": \"geometry.archiesarmy.entities.fuckup\",\n" +
            "\t\t\t\t\"texture_width\": 16,\n" +
            "\t\t\t\t\"texture_height\": 16,\n" +
