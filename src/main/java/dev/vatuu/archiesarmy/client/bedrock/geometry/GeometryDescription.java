...
public final class GeometryDescription {
    ...
    private final Vector3f boundsOffset;
    private final int texWidth, texHeight;

    private GeometryDescription(Identifier id, float boundsW, float boundsH, Vector3f boundsOff, int texW, int texH) {
        this.identifier = id;
    ...
    public static final Codec<GeometryDescription> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            Codecs.VEC_3F.optionalFieldOf("visible_bounds_offset", new Vector3f(1, 1, 1)).forGetter((GeometryDescription o) -> o.boundsOffset),
