...
public class AnimationManager implements SimpleSynchronousResourceReloadListener, AutoCloseable {
    ...
    private static final Identifier LISTENER_ID = ArchiesArmy.id("animation");
    ...
    public void apply(ResourceManager manager) {
        ...
        animData.put(MISSING_IDENTIFIER, ArchiesArmyClient.GSON_CLIENT.fromJson(MISSING_ANIMATION_DATA, AnimationData.class));
    }
